...
.PARAM RS_CD=5k
.PARAM RS=10k
.PARAM RD_CASCODE=45K
.PARAM RD=100k
.PARAM RBIAS_CCCS1=1MEG
.PARAM R_VCVS_BIAS2=1MEG
.PARAM R_VCVS_BIAS1=1MEG
.PARAM R_D_DIFF_AMP=65K
.PARAM R_CCCS_BIAS2=1MEG
.PARAM R_CCCS_BIAS1=1MEG
...
*** Library name: amplifiers
*** Cell name: amplification_ss_experimental
*** View name: schematic
.SUBCKT AMPLIFICATION_SS AMP_INPUT AMP_OUTPUT OUTPUT_CS_2
    XI0 AMP_INPUT OUTPUT_CS_2 VCVS_OUTPUT VCVS_SS
    XI1 NET6 VCVS_OUTPUT AMP_OUTPUT CCCS_SS
    C0 AMP_INPUT NET6 CAP
.ENDS
*** End of subcircuit definition.
"""
                                }
