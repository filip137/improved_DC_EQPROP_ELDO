...
class SimulationParametersDC:
    def __init__(self, scale_factor, bias, batch_size, beta, gamma_values, load_weights, h5_file):
        ...
        # Assign amplifier
        self.amplifier = "PerfectAmpWithNonlin"  # allowed options below
